...
#
# Regression test for OCA timing
#
# The oca_counter parameter should increment by 1 count every 32 ms.
# If it does not, this indicates that the OCA buffer has not been downloaded
# quickly enough (every 32 ms). Perhaps due to an overuse of the I2C bandwidth.
#
# Ideally, this test should be run when DPS is moving frequency and voltage as fast as possible
# during the run so that I2C bandwidth requested is maximized.
#
...
set ::traceitems(trace32ms,sensor_list) {{PWR1MS rcnt}  } 
#Parameter list
