...
#
# Regression test for chip-level average temperature sensors
#
# Read the core-level average temperature sensors and average them to 
# create a chip-level average. Used by power-proxy calibration experiments.
