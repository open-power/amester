...
static void SetAxisRange _ANSI_ARGS_((AxisRange *rangePtr, double min, double max));
static int InRange _ANSI_ARGS_((register double x, AxisRange *rangePtr));
static int AxisIsHorizontal _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr));
static void FreeLabels _ANSI_ARGS_((Rbc_Chain *chainPtr));
static TickLabel *MakeLabel _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, double value));
static void GetDataLimits _ANSI_ARGS_((Axis *axisPtr, double min, double max));
static void FixAxisRange _ANSI_ARGS_((Axis *axisPtr));
static double NiceNum _ANSI_ARGS_((double x, int round));
static Ticks *GenerateTicks _ANSI_ARGS_((TickSweep *sweepPtr));
static void LogScaleAxis _ANSI_ARGS_((Axis *axisPtr, double min, double max));
static void LinearScaleAxis _ANSI_ARGS_((Axis *axisPtr, double min, double max));
static void SweepTicks _ANSI_ARGS_((Axis *axisPtr));
static void ResetTextStyles _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr));
static void DestroyAxis _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr));
static void AxisOffsets _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int margin, int axisOffset, AxisInfo *infoPtr));
static void MakeAxisLine _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int line, Segment2D *segPtr));
static void MakeTick _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, double value, int tick, int line, Segment2D *segPtr));
static void MapAxis _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int offset, int margin));
static double AdjustViewport _ANSI_ARGS_((double offset, double windowSize));
static int GetAxisScrollInfo _ANSI_ARGS_((Tcl_Interp *interp, int argc, char **argv, double *offsetPtr, double windowSize, double scrollUnits));
static void DrawAxis _ANSI_ARGS_((Graph *graphPtr, Drawable drawable, Axis *axisPtr));
static void AxisToPostScript _ANSI_ARGS_((PsToken psToken, Axis *axisPtr));
static void MakeGridLine _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, double value, Segment2D *segPtr));
static void GetAxisGeometry _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr));
static int GetMarginGeometry _ANSI_ARGS_((Graph *graphPtr, Margin *marginPtr));
static void ComputeMargins _ANSI_ARGS_((Graph *graphPtr));
static Axis *CreateAxis _ANSI_ARGS_((Graph *graphPtr, char *name, int margin));
static int ConfigureAxis _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr));
static int NameToAxis _ANSI_ARGS_((Graph *graphPtr, char *name, Axis **axisPtrPtr));
static int GetAxis _ANSI_ARGS_((Graph *graphPtr, char *name, Rbc_Uid classUid, Axis **axisPtrPtr));
static void FreeAxis _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr));

static int BindOp _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int argc, char **argv));
static int CgetOp _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int argc, char *argv[]));
static int ConfigureOp _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int argc, char *argv[]));
static int GetOp _ANSI_ARGS_((Graph *graphPtr, int argc, char *argv[]));
static int LimitsOp _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int argc, char **argv));
static int InvTransformOp _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int argc, char **argv));
static int TransformOp _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int argc, char **argv));
static int UseOp _ANSI_ARGS_((Graph *graphPtr, Axis *axisPtr, int argc, char **argv));
static int CreateVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int BindVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int CgetVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int ConfigureVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int DeleteVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int InvTransformVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int LimitsVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int NamesVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int TransformVirtualOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
static int ViewOp _ANSI_ARGS_((Graph *graphPtr, int argc, char **argv));
