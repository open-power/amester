# RBC.winop.subsample.M.tcl --
#
###Abstract
# This file contains the manual tests that test the subsample 
...
namespace eval winop.subsample {
	...
	proc RBC.winop.subsample.M.1.1.Body {} {
		set src [image create photo -file ./rain.gif]
		...
		winop subsample $src $dest1 0 0 30 30 bell
		winop subsample $src $dest2 0 0 30 30 bessel
		winop subsample $src $dest3 0 0 30 30 box
		winop subsample $src $dest4 0 0 30 30 bspline
		winop subsample $src $dest5 0 0 30 30 catrom
		winop subsample $src $dest6 0 0 30 30 default
		winop subsample $src $dest7 0 0 30 30 dummy
		winop subsample $src $dest8 0 0 30 30 gauss8
		winop subsample $src $dest9 0 0 30 30 gaussian
		winop subsample $src $dest10 0 0 30 30 gi
		winop subsample $src $dest11 0 0 30 30 lanczos3
		winop subsample $src $dest12 0 0 30 30 mitchell
		winop subsample $src $dest13 0 0 30 30 none
		winop subsample $src $dest14 0 0 30 30 sinc
		winop subsample $src $dest15 0 0 30 30 triangle
	...
	proc RBC.winop.subsample.M.1.1.Cleanup {} {
	...
	# ------------------------------------------------------------------------------------
	proc RBC.winop.subsample.M.2.1.Setup {} {
		set src [image create photo -file ./rain.gif]
	...
	proc RBC.winop.subsample.M.2.1.Body {} {
		set src [image create photo -file ./rain.gif]
		set dest1 [image create photo -height 100 -width 100]
		set dest2 [image create photo -height 100 -width 100]
		set dest3 [image create photo -height 100 -width 100]
		...
		winop subsample $src $dest1 0 0 30 30 bell bessel
		winop subsample $src $dest2 0 0 30 30 bessel box
		winop subsample $src $dest3 0 0 30 30 box bspline
		winop subsample $src $dest4 0 0 30 30 bspline catrom
		winop subsample $src $dest5 0 0 30 30 catrom default
		winop subsample $src $dest6 0 0 30 30 default dummy
		winop subsample $src $dest7 0 0 30 30 dummy gauss8
		winop subsample $src $dest8 0 0 30 30 gauss8 gaussian
		winop subsample $src $dest9 0 0 30 30 gaussian gi
		winop subsample $src $dest10 0 0 30 30 gi lanczos3
		winop subsample $src $dest11 0 0 30 30 lanczos3 mitchell
		winop subsample $src $dest12 0 0 30 30 mitchell none
		winop subsample $src $dest13 0 0 30 30 none since
		winop subsample $src $dest14 0 0 30 30 sinc triangle
		winop subsample $src $dest15 0 0 30 30 triangle bell
	...
	proc RBC.winop.subsample.M.2.1.Cleanup {} {
		destroy .button1 .button2 .button3 .button4 .button5 .button6 .button7 .button8 .button9 .button10 .button11 .button12 .button13 .button14 .button15
	}
}
