# RBC.barchart.legend.deactivate.M.tcl --
#
###Abstract
...
namespace eval barchart.legend {
    ...
    # ------------------------------------------------------------------------------------     
    proc RBC.barchart.legend.deactivate.M.1.1.Setup {} {
        barchart .barchart1
    ...
    proc RBC.barchart.legend.deactivate.M.1.1.Body {} {
        .barchart1 legend deactivate *
    }
    
    proc RBC.barchart.legend.deactivate.M.1.1.Cleanup {} {
        destroy .barchart1
    } 
    ...
    # ------------------------------------------------------------------------------------
    proc RBC.barchart.legend.deactivate.M.1.2.Setup {} {
        barchart .barchart1
        set X [list 1 2 3 4 5]
        set Y [list 2 4 6 8 10]
        .barchart1 element create Line1 -x $X -y $Y
    ...
    proc RBC.barchart.legend.deactivate.M.1.2.Body {} {
        .barchart1 legend deactivate Line1
    }
    
    proc RBC.barchart.legend.deactivate.M.1.2.Cleanup {} {
        destroy .barchart1
    }     
}