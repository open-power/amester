# RBC.graph.element.deactivate.M.tcl --
#
###Abstract
...
namespace eval graph.element {
	...
	# element name.
	# ------------------------------------------------------------------------------------
	proc RBC.graph.element.deactivate.M.1.1.Setup {} {
		graph .graph1
		pack .graph1
	...
	proc RBC.graph.element.deactivate.M.1.1.Body {} {
		.graph1 element deactivate Element1
	}
	
	proc RBC.graph.element.deactivate.M.1.1.Cleanup {} {
